...
function firstWindowOpen() {
  window.open("../../games/html5-fruit-ninja/index.html");
}

function secondWindowOpen() {
  window.open("../../games/StreetFighter-master/index.html");
}

function thirdWindowOpen() {
  window.open("../../games/html5-pcman/index.html");
}
